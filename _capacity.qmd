...
for (i in c(2,3,4,6,7)) {
  mytext <- apply(cap_er_all[(cap_heading_positions[i-1]+1):(cap_heading_positions[i]-1), ], 2, function(col) paste(col, collapse = "<br>"))
  ...
  assign(paste0("cap_er_1_", i, "_r"), mytext)
...
`r if (exists("cap_trm_1_1_r") == FALSE) {''} else {cap_trm_1_1_r[1,1]}`

`r if (exists("cap_trm_1_2") == FALSE) {''} else {cap_trm_1_2}`

`r if (exists("cap_trm_1_3") == FALSE) {''} else {cap_trm_1_3}`
...
`r if (exists("cap_trm_1_6_r") == FALSE) {''} else {cap_trm_1_6_r[1,1]}`
...
`r if (exists("cap_trm_1_4") == FALSE) {''} else {cap_trm_1_4}`


**ATC pre-departure delay**

`r if (exists("cap_trm_1_5_r") == FALSE) {''} else {cap_trm_1_5_r[1,1]}`
