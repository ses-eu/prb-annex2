...
cap_heading_ukraine <- which(cap_er_all$a %in% c("Additional information relating to Russia's war of agression against Ukraine", "**Additional information relating to Russia's war of agression against Ukraine**"))
...
# ACC text --------------
  ...
  cap_er_nsa_5 <- paste0(mytext, mytext_acc)
...
`r if_else(length(cap_heading_ukraine) == 0, "**Application of Corrective Measures for Capacity (if applicable)**", "**Additional information relating to Russia's war of agression against Ukraine**")`
