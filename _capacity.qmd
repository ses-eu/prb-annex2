...
for (i in 1:length(cap_trm_heading_positions)) {
  if (i<length(cap_trm_heading_positions)) {
    mytext <- apply(cap_trm_all[(cap_trm_heading_positions[i]+1):(cap_trm_heading_positions[i+1]-1), ], 2, function(col) paste(col, collapse = "<br>"))
  } else{
    mytext <- apply(cap_trm_all[(cap_trm_heading_positions[i]+1):(cap_trm_heading_positions[i]+1), ], 2, function(col) paste(col, collapse = "<br>"))
  ...
  ### assign text to variable
  assign(paste0("cap_trm_1_", i, "_r"), mytext)
