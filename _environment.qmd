...
for (i in 1:length(env_apt_heading_positions)) {
  if (i<length(env_apt_heading_positions)) {
    mytext <- apply(env_apt_all[(env_apt_heading_positions[i]+1):(env_apt_heading_positions[i+1]-1), ], 2, function(col) paste(col, collapse = "<br>"))
  } else{
    mytext <- apply(env_apt_all[(env_apt_heading_positions[i]+1):(env_apt_heading_positions[i]+1), ], 2, function(col) paste(col, collapse = "<br>"))
...
for (i in 1:length(env_mil_heading_positions)) {
  if (i<length(env_mil_heading_positions)) {
    mytext <- apply(env_mil_all[(env_mil_heading_positions[i]+1):(env_mil_heading_positions[i+1]-1), ], 2, function(col) paste(col, collapse = "<br>"))
  } else{
    mytext <- apply(env_mil_all[(env_mil_heading_positions[i]+1):(env_mil_heading_positions[i]+4), ], 2, function(col) paste(col, collapse = "<br>"))
