...
::::: {.chart-container}  
```{r chart_level2_saf_ri_year_report, eval= (params$country != "MUAC") & (params$country != "SES RP3"), options = (safindicator=c("ri"))}
...
:::: {layout="[ 40, 60 ]"}
::::: {.chart-container}  
```{r chart_saf_smi, eval= params$country != "MUAC"}
...
::::: {.chart-container}  
```{r chart_level2_saf_smi_year_report, eval= (params$country != "MUAC") & (params$country != "SES RP3"), options = (safindicator=c("smi"))}
#| file: R/chart_level2_saf_ri_smi_year_report.R
#| out.width: "100%"
```
:::::
...
```{r table_level2_saf_smi_ansp, eval= params$country != "MUAC"}
...
::::: {.chart-container}  
```{r table_level2_saf_autotools, eval= params$country != "MUAC"}
