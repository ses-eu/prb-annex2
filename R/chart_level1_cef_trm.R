...
for (tz in 1:no_tcz) {
  ...
  #### title
  mytitle_text <- paste0("Terminal unit costs - ", tcz_list$tcz_name[tz])

  #### xaxis

  #### yaxis
  myyaxis_title <- "Terminal unit costs (€2017)"
  myyaxis_ticksuffix <- ""
  ...
  myplot[[tz]] <- mybarchart(data_prep, mywidth, myheight, myfont, mylocalmargin)
  # myplot[[tz]]
