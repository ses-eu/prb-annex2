...
```{r chart_saf_l1, include=FALSE, , options = (saf_ansp_index = 1)}
...
mytable <-"table_level2_saf_ri_apt"
...
cap_conc1 <- paste0(if_else(cap_er_conc1 == "character(0\n", "", paste0(cap_er_conc1, "\n\n")), if_else(cap_trm_conc1 == "NA", "", cap_trm_conc1))

cap_text <- break_l1_text(cap_conc1) 
...
`r layout_summary_table(table_level2_saf_ri_apt, hspace = 0, left_margin = 0, width = 1)`
...
`r layout_summary_table(table_level2_saf_autotools, left_margin = 4.5, width = 0.5)`

<!-- test if this below works-->
:::: {layout="[ 25, 50, 25 ]"}
::::: {#emptydiv}  
:::::
...
`r latex_linebreaks(saf_asdr_text)`
