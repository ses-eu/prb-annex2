...
On behalf of all the PRB members, I would like to thank our colleagues from Eurocontrol, namely the Network Management Directorate and the Performance Review Unit, our colleagues from the European Aviation Safety Agency (EASA), and the PRB Support Team for their invaluable contributions to this report.  
...
::: {#container-scope}
:::: {#scope-desctiption class="equal-column"}
...
The costs related to the provision of these services is financed directly by the users though a system of charges, which is organised on the basis of 29 en route and 26 terminal charging zones.  
::::

:::: {#scope-map class="equal-column-right"}
::::: {#observablehq-mlowerap-aa7c0a21 style="width: 100%;border: 1px solid black;"}
:::::
:::::{#observablehq-style-aa7c0a21 style="width: 100%;border: 1px solid black;"}
:::::
...
<script type="module">
  ...
  import define from "https://api.observablehq.com/d/3146482a65da21fc.js?v=3";
	new Runtime().module(define, name => {
	if (name === "mlowerap") return new Inspector(document.querySelector("#observablehq-mlowerap-aa7c0a21"));
	if (name === "style") return new Inspector(document.querySelector("#observablehq-style-aa7c0a21"));
});
</script>