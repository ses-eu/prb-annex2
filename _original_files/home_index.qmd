...
::: {.g-col-lg-6 .g-col-12}
::: {.grid style="gap: 0rem"}
::: {.g-col-6 .text-center .text-pad-top style="border: 1px solid black"}
**IFR movements** <br>8,345 ('000) flights <br>(+52% vs 2021) <br>[-]{style="color:white;"}
:::

::: {.g-col-6 .text-center .text-pad-top style="border-top: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black"}
**En route service units (SUs)** <br>108,380 ('000) SUs <br>(+3.8% vs plan) [{{< fa solid arrow-up >}}]{style="color: #92d050;"} <br>(+62% vs 2021)
:::
:::

::: {.grid style="gap: 0rem"}
::: {.g-col-6 .text-pad-top .text-center style="border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black"}
...
::: {.g-col-6 .text-pad-top .text-center style="border-bottom: 1px solid black; border-right: 1px solid black"}
**Environment KPA** <br>KEA: 2.96% <br>(+0.59p.p. vs target) [{{< fa solid arrow-up >}}]{style="color: #FF0000;"}
:::
:::

::: {.grid style="gap: 0rem"}
::: {.g-col-6 .text-center .text-pad-top style="border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black"}
**Capacity KPA** <br>En route ATFM delay: 1.69 min/flt <br>(+1.19 min/flt vs target) [{{< fa solid arrow-up >}}]{style="color: #FF0000;"}
:::

::: {.g-col-6 .text-center .text-pad-top style="border-bottom: 1px solid black; border-right: 1px solid black"}
