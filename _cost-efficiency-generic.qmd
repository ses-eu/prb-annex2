...
## En route CZ - {{< var doc.ecz@@cz_index@@ >}}
...
```{r chart-cef-er-duc, options = (cz=c("@@cz_index@@", "enroute"))}
...
```{r chart-cef-su, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-cost, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-cost-entity, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-cost-main, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-aucu, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-cex, R.options = list(ez=@@cz_index@@)}
...
```{r chart-cef-er-reg-res, options = (ez=@@cz_index@@)}
#| file: R/chart_level2_cef_er_reg_res.R
#| out.width: "100%"
```

```{r chart-cef-er-reg-res_aucu, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-reg-res-ansp, options = (ez=@@cz_index@@)}
...
```{r chart-cef-er-reg-res-main-ansp, options = (ez=@@cz_index@@)}
