...
if (country == "SES RP3") {
  ...
  cef_txt_1_4 <- data.frame(a=c(NA,NA), b=c(NA,NA))
  
  my_index_su <- 1
  my_index_cost_by_ent <- 1
  my_index_cost_main <- 1
  
  cef_txt_1_5 <- data.frame(a=c(NA,NA), b=c(NA,NA))
  cef_txt_1_10 <- data.frame(a=c(NA,NA), b=c(NA,NA))
  cef_txt_1_13 <- data.frame(a=c(NA,NA,NA,NA,NA), b=c(NA,NA,NA,NA,NA))
