...
### this range is different as of 2022
if (year_report >= 2022) {
  ...
  heading4_1 <- str_locate(tx, fixed(') at charging zone level**<br/>'))
  heading4_2 <- str_locate(tx, fixed(') at charging zone level<br/>**'))
  ...
  cef_txt_1_4_cost_main <- str_replace_all(substr(tx, max(heading4_1, heading4_2, na.rm = TRUE)+1, nchar(tx)) , fixed("<br/><br/>"), fixed("<br/>"))
...
range <- if_else(year_report >= 2022, "C66:M71", "C65:M71")
...
`r if_else(year_report >= 2022, pull(cef_txt_1_4[2,1]), cef_txt_1_4_duc)`

**En route service units**

`r if_else(year_report >= 2022, pull(cef_txt_1_4[my_index_su,1]), cef_txt_1_4_su)`

**En route costs by entity**

`r if_else(year_report >= 2022, pull(cef_txt_1_4[my_index_cost_by_ent,1]), cef_txt_1_4_cost_all)`

**En route costs for the main ANSP at charging zone level**

`r if_else(year_report >= 2022, pull(cef_txt_1_4[my_index_cost_main,1]), cef_txt_1_4_cost_main)`
