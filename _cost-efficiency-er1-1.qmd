...
```{r chart-cef-er-cost, options = (ez=1)}
...
```{r chart-cef-er-cost-entity, options = (ez=1)}
...
```{r chart-cef-er-cost-main, options = (ez=1)}
...
```{r chart-cef-er-aucu, options = (ez=1)}
...
```{r chart-cef-er-cex, R.options = list(ez=1)}
#| file: R/chart_level2_cef_er_cex.R
#| out.width: "100%"
```
::::
...
```{r chart-cef-er-reg-res, options = (ez=1)}
#| file: R/chart_level2_cef_er_reg_res.R
#| out.width: "100%"
```

```{r chart-cef-er-reg-res_aucu, options = (ez=1)}
...
```{r chart-cef-er-reg-res-ansp, options = (ez=1)}
...
```{r chart-cef-er-reg-res-main-ansp, options = (ez=1)}
#| file: R/chart_level2_cef_er_reg_res_main_ansp.R
#| out.width: "100%"
```
